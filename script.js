...
function updateBackgroundText(text){
  let myElement=document.querySelector(".backgroundText")
...
function updateDisplay() {
  ...
  displayStr=getNumberWord(displayValue)
  console.log(displayStr)
  backgroundText=backgroundText+displayStr
...
function getNumberWord(num){
  ...
  for (let i = 0; i < arrTripleWords.length; i++) {
    if(i>0){hDigitWords.push(higher_digits[i-1])}
  }
  hDigitWords.reverse()
  ...
  // console.log(arrTripleWordsFinal.join(' '))
